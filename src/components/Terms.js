          ...
          <div className="flex flex-col flex-1 px-4">
            <div>
              ...
              <p className="mt-4">
               ...
               <SimpleLinks className="text-primary-200">starbucks.com/rewards/terms</SimpleLinks>
                .
              </p>
              <p className="mt-4">
              ...
              <p className="mt-4">
                ...
                <SimpleLinks className="text-primary-200">Starbucks Store Locator</SimpleLinks>
