function Footer() {
  return (
    <>
      <footer className="py-10 mt-12 border-t-2 border-gray-300">
        <div className="flex flex-col px-8 divide-y divide-gray-400">
          <div className="flex flex-col lg:flex-row">
              ...
              <div>
                <div className="lg:hidden">
                  <button className="focus:outline-none">
                    <svg
                      viewBox="0 0 24 24"
                      className="w-8 h-8 overflow-visible fill-current valign-middle absoluteCenter"
              ...
              <div className="flex flex-col">
                ...
                <div className="hidden lg:block">
                  <div className="flex flex-col mt-8">
                    ...
                    <a
                      className="mt-6 text-base font-normal text-gray-400 hover:text-black"
                      href="/"
                    >
                      Our Coffee
                    </a>
            ...
            <div className="flex flex-row-reverse justify-between mt-4 lg:ml-8">
              <div>
                <div className="lg:hidden">
                  <button className="focus:outline-none">
                    <svg
            ...
            <div className="flex flex-row-reverse justify-between mt-4 lg:ml-8">
              ...
              <div className="flex flex-col">
                <div>
                  <h2 className="text-xl font-medium">Social Impact</h2>
                </div>
                <div className="hidden lg:block">
                  <div className="flex flex-col mt-8">
                    <a
            ...
            <div className="flex flex-row-reverse justify-between mt-4 lg:ml-8">
              ...
              <div className="flex flex-col">
                <div>
                  <h2 className="text-xl font-medium">For Business Partners</h2>
                </div>
                <div className="hidden lg:block">
                  <div className="flex flex-col mt-8">
                    <a
            ...
            <div className="flex flex-row-reverse justify-between mt-4 lg:ml-8">
              ...
              <div className="flex flex-col">
                <div>
                  <h2 className="text-xl font-medium">Order and Pickup</h2>
                </div>
                <div className="hidden lg:block">
                  <div className="flex flex-col mt-8">
                    <a
          ...
          <div className="flex flex-col mt-8">
            ...
            <div className="flex flex-col mt-4 lg:divide-x-2 lg:divide-gray-500 lg:flex-row">
              <a className="mt-4 text-base lg:pr-6 hover:underline" href="/">
                Privacy Policy
              </a>
              <a className="mt-4 text-base lg:px-6 hover:underline" href="/">
                Terms of Use
              </a>
              <a className="mt-4 text-base lg:px-6 hover:underline" href="/">
                CA Supply Chain Act
              ...
              <a className="mt-4 text-base lg:pl-6 hover:underline" href="/">
                Cookie Preferences
              </a>
            </div>
          </div>
        </div>
        <p className="px-8 mt-4 text-base text-gray-400">
